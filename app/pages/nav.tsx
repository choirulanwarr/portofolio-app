    ...
    <nav className="nav hidden lg:block" aria-label="In-page jump links">
      <ul className="mt-16 w-max">
        <li>
          ...
          >
            <span className={`nav-indicator mr-4 h-px w-${isActive('#about') ? '16' : '8'} bg-slate-${isActive('#about') ? '200' : '600'} transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}></span>
        ...
        <li>
          ...
          >
            <span className={`nav-indicator mr-4 h-px w-${isActive('#experience') ? '16' : '8'} bg-slate-${isActive('#experience') ? '200' : '600'} transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}></span>
        ...
        <li>
          ...
          >
            <span className={`nav-indicator mr-4 h-px w-${isActive('#projects') ? '16' : '8'} bg-slate-${isActive('#projects') ? '200' : '600'} transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none`}></span>
