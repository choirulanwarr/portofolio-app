   ...
   return (
      <footer className="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
         <p>
            ...
            All text is set in the <a href="https://rsms.me/inter/" className="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300" target="_blank" rel="noreferrer noopener" aria-label="Inter (opens in a new tab)">Inter</a> 
            &nbsp; typeface.
         </p>
      </footer>
   )
