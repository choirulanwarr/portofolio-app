          ...
          <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
            ...
            <section id="experience" className="mb-16 scroll-mt-16 md:mb-16 lg:mb-16 lg:scroll-mt-16" aria-label="Work experience">
              ...
              <div>
                ...
                <div className="mt-12">
                  <a className="inline-flex items-baseline leading-tight hover:text-teal-300 focus-visible:text-teal-300 font-semibold text-slate-200 group/link text-base" href="/resume.pdf" target="_blank" rel="noreferrer noopener" aria-label="View Full Resume (opens in a new tab)">
